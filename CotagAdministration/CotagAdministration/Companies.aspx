<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeBehind="Companies.aspx.cs" Inherits="Companies" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <asp:GridView ID="gvCompany" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                OnPageIndexChanging="gvCompany_PageIndexChanging" OnRowCommand="gvSite_RowCommand">
                <Columns>
                    <asp:BoundField DataField="ID" HeaderText="SiteNo" ReadOnly="True" SortExpression="SiteNo" />
